...
* For product documentation visit our <a href="http://support.allaccessible.org" target="_blank">Knowledge Base</a>
* For informational videos and tutorials, visit our <a href="https://www.youtube.com/channel/UC5vr6vx1xLfDV_gCbwXf9wQ" target="_blank">YouTube Channel</a>
...
<a href="https://www.allaccessible.org/become-a-partner/" target="_blank">Apply to be a partner here</a>

[youtube https://www.youtube.com/watch?v=0pZCViAKzoE]
...
For Plugin Support, visit the <a href="http://support.allaccessible.org" target="_blank">AllAccessible Support Page</a>
<a href="https://www.allaccessible.org/terms-conditions/" target="_blank">AllAccessible Terms and Conditions</a>

= AllAccessible Would Love Your Feedback =

Our goal is to simplify content management between both platforms. Please share any feedback using the <a href="https://www.allaccessible.org/feedback">AllAccessible Feedback Form.</a>
...
= 1.3.2 =
* Updated Plugin Status on Settings Page

= 1.3.1 =
* Improved Efficiency.

= 1.3 =
* Updated Plugin Settings page to include additional information about the plugin, plugin preview button, and links to support.

= 1.2.10 =
* Release of free version widget
...
* Added a deactivation survey to gain insight for plugin/application improvements
...
= 1.2.2 =
* Added More widget settings options

= 1.2.1 =
* Improved load time and widget configuration options

= 1.2 =
* Added Widget customization options in the widget settings page
...
= 1.1.1 =
* Added widget positioning option.
